...
{
    a.iter().zip(b.iter()).map(|(b1, b2)| *b1 ^ *b2).collect()
}
...
pub fn xor_hashes(input: &Vec<String>) -> String {
    ...
    let res = cloned
        .iter()
        .fold(init, |acc, x| xor(&acc, &x.from_hex().unwrap()));
...
mod tests {
    ...
    fn xor_test() {
        ...
        let a =
            FromHex::from_hex("9b80fc5cba6238801d745ca139ec639924d27ed004c22609d6d9409f1221b8ce")
                .unwrap();
        let b =
            FromHex::from_hex("781ff33f4d7d36b3f599d8125fd74ed37e2a1564ddc3f06fb22e1b0bf668a4f7")
                .unwrap();
        let res =
            FromHex::from_hex("e39f0f63f71f0e33e8ed84b3663b2d4a5af86bb4d901d66664f75b94e4491c39")
                .unwrap();
