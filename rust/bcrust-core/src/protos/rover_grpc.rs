...
pub trait Rover {
    ...
    fn collect_block(&self, o: ::grpc::RequestOptions, p: ::grpc::StreamingRequest<super::core::Block>) -> ::grpc::SingleResponse<super::core::Null>;

    fn report_sync_status(&self, o: ::grpc::RequestOptions, p: super::rover::RoverSyncStatus) -> ::grpc::SingleResponse<super::core::Null>;

    fn report_block_range(&self, o: ::grpc::RequestOptions, p: super::rover::RoverMessage_RoverBlockRange) -> ::grpc::SingleResponse<super::core::Null>;
...
pub struct RoverClient {
    ...
    method_ReportBlockRange: ::std::sync::Arc<::grpc::rt::MethodDescriptor<super::rover::RoverMessage_RoverBlockRange, super::core::Null>>,
...
impl RoverClient {
    pub fn with_client(grpc_client: ::grpc::Client) -> Self {
        RoverClient {
            ...
            method_ReportBlockRange: ::std::sync::Arc::new(::grpc::rt::MethodDescriptor {
                name: "/bc.Rover/ReportBlockRange".to_string(),
                streaming: ::grpc::rt::GrpcStreaming::Unary,
                req_marshaller: Box::new(::grpc::protobuf::MarshallerProtobuf),
                resp_marshaller: Box::new(::grpc::protobuf::MarshallerProtobuf),
            }),
...
impl Rover for RoverClient {
    ...
    fn collect_block(&self, o: ::grpc::RequestOptions, p: ::grpc::StreamingRequest<super::core::Block>) -> ::grpc::SingleResponse<super::core::Null> {
        self.grpc_client.call_client_streaming(o, p, self.method_CollectBlock.clone())
    }
    ...
    fn report_block_range(&self, o: ::grpc::RequestOptions, p: super::rover::RoverMessage_RoverBlockRange) -> ::grpc::SingleResponse<super::core::Null> {
        self.grpc_client.call_unary(o, p, self.method_ReportBlockRange.clone())
    }
        ...
        ::grpc::rt::ServerServiceDefinition::new("/bc.Rover",
            vec![
                ...
                ::grpc::rt::ServerMethod::new(
                    ...
                    {
                        let handler_copy = handler_arc.clone();
                        ::grpc::rt::MethodHandlerClientStreaming::new(move |o, p| handler_copy.collect_block(o, p))
                    },
                ),
                ::grpc::rt::ServerMethod::new(
                    ::std::sync::Arc::new(::grpc::rt::MethodDescriptor {
                ...
                ::grpc::rt::ServerMethod::new(
                    ...
                    {
                        let handler_copy = handler_arc.clone();
                        ::grpc::rt::MethodHandlerUnary::new(move |o, p| handler_copy.report_block_range(o, p))
                    },
                ),
                ::grpc::rt::ServerMethod::new(
                    ::std::sync::Arc::new(::grpc::rt::MethodDescriptor {
