...
/**
 * @param {string} value
 * @return {!proto.bc.BlockFingerprint} returns this
 */
...
proto.bc.MinerRequest.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(8, f, core_pb.BcBlock.serializeBinaryToWriter);
  }
  f = message.getNewBlockHeaders();
  if (f != null) {
    writer.writeMessage(9, f, core_pb.BlockchainHeaders.serializeBinaryToWriter);
  }
};
...
/**
 * @param {string} value
 * @return {!proto.bc.MinerRequest} returns this
 */
...
proto.bc.MinerRequest.prototype.getLastPreviousBlock = function () {
  return (/** @type{?proto.bc.BcBlock} */jspb.Message.getWrapperField(this, core_pb.BcBlock, 8)
  );
};
...
proto.bc.MinerRequest.prototype.getNewBlockHeaders = function () {
  return (/** @type{?proto.bc.BlockchainHeaders} */jspb.Message.getWrapperField(this, core_pb.BlockchainHeaders, 9)
  );
};
 ...
 * @return {!proto.bc.MinerResponse} returns this
 */
