...
proto.bc.BcBlock.prototype.getTxsList = function() {
  return /** @type{!Array<!proto.bc.Transaction>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.bc.Transaction, 21));
};
...
proto.bc.BcBlock.prototype.getBlockchainHeaders = function() {
  return /** @type{?proto.bc.BlockchainHeaders} */ (
    jspb.Message.getWrapperField(this, proto.bc.BlockchainHeaders, 25));
};
...
proto.bc.WalletData.prototype.getCollateralizedSpendableOutpointsList = function() {
  return /** @type{!Array<!proto.bc.WalletOutPoint>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.bc.WalletOutPoint, 8));
};
...
proto.bc.Utxo.prototype.getOutput = function() {
  return /** @type{?proto.bc.TransactionOutput} */ (
    jspb.Message.getWrapperField(this, proto.bc.TransactionOutput, 1));
};
