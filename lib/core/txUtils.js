...
const getNrgGrant = exports.getNrgGrant = (potentialEmblemNrg, distanceWithEmblems, txsConsumedDistance, blockHeight) => {
  ...
  debugEmb(`getOlGrant(): potential Emblem NRG: ${potentialEmblemNrgBN.toNumber()}, distance with Emblems: ${distanceWithEmblemsBN.toNumber()}, txs consumed distance: ${txsConsumedDistance.toNumber()} `);
