...
class TxHandler {
  ...
  async isValidTx(tx, opts) {
    ...
    for (let input of inputs) {
      ...
      if (!result) {
        this._txPendingPool.markTxsAsMined([tx]);
        debug(`script did not validate, result: ${result}`);
        return false;
      }
    }
  ...
  async validateTxs(block) {
    ...
    // scout block A
    if (block.getHash() === "c96a3b7d36cc83a84c416fff6c76f3791d44224b307e103c41940d1f59cf3ffe") {
      return true;
    }

    // scout block B
    if (block.getHash() === "29090a964c56107a84820bf5caf70a629e5ada8337220c8b1a61acc2269e91e0") {
      return true;
    }

    // scout block C
    if (block.getHash() === "f7f1f845e7aeb41f6929900eaf8eda0911932785c9831065f80b4e2574527b68") {
      return true;
    }

    // scout block D
    if (block.getHash() === 'b24263d12b0c48cd16be2e089c0beb07795f4b1fc83205f5bb44429a0145de72') {
      return true;
    }

    if (block.getHash() === '49699e566a0262d000644d44249566432e6b490bb0e91f2d31f3dc69f9060e4c') {
      return true;
    }

    if (block.getHash() === '101f865e7270f1fc4b6551d0a64fb48ae3b76b611dbc748bc3c7b66762f1e858') {
      return true;
    }

    if (block.getHash() === 'f6a7a72e36803fb7fedf09dc2ddc471db5c12ed0f2df7e403bb9c3526f838d7d') {
      return true;
    }

    if (block.getHash() === 'aba220b8225b4e32771cd65f4d90ba7b8c5a19f9e97517adb361251cd5d50337') {
      return true;
    }

    if (block.getHash() === '49f7a97b434c3935c182845960ebd98331522d72fabfe01fe6d15d185adfef66') {
      return true;
    }

    if (block.getHash() === 'bc8f395d6b61d390867852bd0285d0f0b1db4cbb499439349699b4b4d5b0ce50') {
      return true;
    }

    if (block.getHash() === '665367bf11800dec4ac4057a5c78dbdfa4f6caa925eaae48ce51680d29fc5bec') {
      return true;
    }

    if (block.getHash() === '196e92a80496cead4ce0bbb37aaa6a149f9abf2867c508a0fef225c9e7879484') {
      return true;
    }

    if (block.getHash() === '9fea92a6de565e8e9f3c8e97885b43ddccc42c652603c398d503262e35bd0ef1') {
      return true;
    }

    if (block.getHash() === '88fbc8627a70f0767a997047f8c70a0859d826334d82b3507066875b244b9fc7') {
      return true;
    }

    if (block.getHash() === '28a0b2011dc915c42015713386ecc9cd1440bc30b563f10993b43e6ba1845e74') {
      return true;
    }

    if (block.getHash() === '21ca81cd0349d4b9acf4f40185bb714f70b5c31a97f469770dae1bc04d8a6ade') {
      return true;
    }

    if (block.getHash() === 'be6a2023cbcc453dae8c6aaf573c9a17bbf23d9a8cea1b8682bb9d0572a2819c') {
      return true;
    }
