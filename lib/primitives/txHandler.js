  ...
  async validateOutputs(tx) {
    ...
    for (let i = 0; i < outputs.length; i++) {
      ...
      if (scriptType == 'taker_output') {
        ...
        // console.log({val:val.toNumber(),unit:unit.toNumber(),base})
      ...
      if (!_txUtils.ScriptTemplates.validateOutput(output)) {
