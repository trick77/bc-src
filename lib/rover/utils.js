...
const ROVER_RESYNC_PERIOD = exports.ROVER_RESYNC_PERIOD = Math.floor(0.5 * 60 * 60);
...
function getBacksyncEpoch(rover) {
  ...
  const initialWeight = Number(ROVER_SECONDS_PER_BLOCK[rover.toLowerCase()]) * 10000 - shift;
