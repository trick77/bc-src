...
async function _createUnifiedBlock(roverRpc, block, isStandalone, oldBlock = false) {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      while (block && block.transactions && block.transactions.length > 0 && obj.blockNumber > 12426601 || BC_ETH_MARKED_TEST && block && block.transactions && block.transactions.length > 0) {
      ...
      if (!oldBlock && obj.blockNumber > 12426601 || BC_ETH_MARKED_TEST) {
