...
// BYZ FORK
const CLIMB_BLOCK_NR = 12306826;
const CLIMB_BLOCK = '1c220cb6040c5d92739f731f8ae6821d5589b716ca2456ab1e41a3c680620360';
  ...
  constructor(config) {
    ...
    this._syncCheckTimeout = setInterval(async () => {
      ...
      if (this._bestSeenBlock) {
        ...
        } else if (this._blocksToFetch.length < 1 && peers.length < WAIT_FOR_PEERS && reportBelowMinPeer && this._peerFailed > 5) {
