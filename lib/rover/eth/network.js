...
const commonBerlin = new _common2.default({ chain: 'mainnet', eips: [2718, 2930, 2929, 2565, 2315, 2537], hardfork: 'berlin', supportedHardforks: ['berlin', 'istanbul', 'homestead', 'byzantium', 'petersburg', 'constantinople', 'spuriousDragon', 'dao', 'chainstart'] });
//const common = new Common({ chain: 'mainnet', eips: [2718,2930,2929,2565,2315,2537], hardfork: 'berlin', supportedHardforks: ['berlin', 'istanbul','homestead','byzantium','petersburg','constantinople','spuriousDragon','dao','chainstart'] })
