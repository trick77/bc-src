...
// BYZ FORK
const CLIMB_BLOCK_NR = 12290496;
const CLIMB_BLOCK = 'ea1104aab44f46fa900e0ce3166bcdec05c6de1eec64dc411bde903a762b7d62';
  ...
  constructor(config) {
    ...
    this._syncCheckTimeout = setInterval(async () => {
      ...
      if (this._bestSeenBlock) {
        ...
        if (!this._seekingBlockSegment && this._reportLatestBlockHeight && this._blocksIndexed > 0 && this._blocksIndexed < 10000 && this._reportLatestBlockHeight !== blockNumber) {
          debug(`requesting next segment from ${this._reportLatestBlockHeight}`);
          await this.getBlockchain(this._reportLatestBlockHeight, this._reportLatestBlockHeight + 50);
          return;
        } else {
