...
class FetchIntervalStore {
  ...
  foundBlock(height) {
    this._logger.debug('foundBlock(): height = %d, isArray = %o, includes = %o', height, Array.isArray(this._currentlySeekingHeights), this._currentlySeekingHeights.includes(height));
    if (Array.isArray(this._currentlySeekingHeights) && this._currentlySeekingHeights.includes(height)) {
    ...
    if (this._currentlySeekingHeights && this._currentlySeekingHeights.length === 0) {
      this._currentlySeekingHeights = null;
    }
