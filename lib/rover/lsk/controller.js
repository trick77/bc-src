...
class Controller {
  ...
  async _httpApi(method, opts, data) {
    ...
    const urls = ['http://104.237.2.140:8000/api/', 'http://116.203.73.30:8000/api/', 'http://104.237.3.226:8000/api/', 'http://78.46.147.196:8000/api/', 'http://5.9.99.62:8000/api/', 'http://160.16.139.105:8000/api/', 'http://104.237.9.142:8000/api/', 'http://2.56.213.101:8000/api/'];
