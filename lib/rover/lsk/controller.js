...
function validateRoverBlockRange(roverBlockRange) {
...
function validateFetchBlock(fetchBlock) {
...
function validateRequestResync(resync) {
        ...
        case RoverMessageType.REQUESTRESYNC:
          {
            ...
            if (validateRequestResync(payload)) {
        ...
        case RoverMessageType.ROVER_BLOCK_RANGE:
          {
            ...
            if (validateRoverBlockRange(data)) {
