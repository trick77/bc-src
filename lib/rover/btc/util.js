...
const templatePK = require('bitcoinjs-lib/src/templates/pubkey');
...
function extractAddressFromOutput(output) {
  ...
  // P2PK does not have a standardized address format
  // see https://github.com/bitcoinjs/bitcoinjs-lib/issues/1587 for explanation
  if (templatePK.output.check(output.script)) {
    return null;
  }
