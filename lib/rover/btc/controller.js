...
const BTC_MAX_FETCH_BLOCKS = Math.floor(ROVER_RESYNC_PERIOD / ROVER_SECONDS_PER_BLOCK['btc']) + 290;
...
const BTC_SYNCHRONIZATION_STOP = exports.BTC_SYNCHRONIZATION_STOP = '0000000000000000000ae738caf5078f3d2c9d3a8f5cf1f6441fc6c1abfb1b2f'; // 629605
...
async function _createUnifiedBlock(roverRpc, block, isStandalone) {
  ...
  for (let tx of block.transactions) {
    ...
    try {
      ...
      const pairs = xprod(inputAddresses, t.outs);
