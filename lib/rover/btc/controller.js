...
let BTC_SYNCHRONIZATION_STOP = exports.BTC_SYNCHRONIZATION_STOP = '0000000000000000001160c60aedc479a0d93e0be51909c2c57d30969123fd0e'; // 689731
  ...
  try {
    ...
    for (let i = 0; i < checksBatch.length; i++) {
      try {
        ...
        newMarkedTransactions = await roverHelp.isBeforeSettleHeight(c, roverRpc, headerObj.hash);
