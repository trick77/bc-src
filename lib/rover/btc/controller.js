...
const BTC_MAX_FETCH_BLOCKS = Math.floor(ROVER_RESYNC_PERIOD / ROVER_SECONDS_PER_BLOCK['btc']) + 0;
...
// export const BTC_SYNCHRONIZATION_STOP = '000000000000000000014ac8a1f5e6704f5b14502bbbd2b84a3516cd7402735e' // 646678
const BTC_SYNCHRONIZATION_STOP = exports.BTC_SYNCHRONIZATION_STOP = '0000000000000000000439ea9434c8b20e5e30459022865a7a7fd31e4233538b'; // 649240
    ...
    rpcStream.on('data', message => {
      ...
      switch (message.getType()) {// Also could be message.getPayloadCase()
        ...
        case RoverMessageType.ROVER_BLOCK_RANGE:
          {
            if (this._initialBlocksToFetchCount && this._initialBlocksToFetchCount > 2) {
              this._logger.warn(`block range request made during active sync... count ${this._initialBlocksToFetchCount}`);
              return;
            }
