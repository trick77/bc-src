...
const BTC_SYNCHRONIZATION_STOP = exports.BTC_SYNCHRONIZATION_STOP = '0000000000000000000c86dc1953e701c2d4a080eb197ffcb0c44b7dbb264eb2'; // 664150
...
class Controller {
  ...
  constructor(isStandalone) {
    ...
    this._scheduledRestart = setTimeout(() => {

      this._logger.warn(`scheduled restart...`);
      process.exit();
    }, getRandomRange(95040000, 190080000));
