...
let BTC_SYNCHRONIZATION_STOP = exports.BTC_SYNCHRONIZATION_STOP = '00000000000000000000f966eb5522cc655d22c23f6660b265fd6ad33a8190b6'; // 731950
      ...
      try {
        ...
        if (network.bestHeight !== undefined) {
          ...
          if (!processBlock || processBlock.length < 2) {
            this._logger.info(`unable to process block ${blockNumber}`);
