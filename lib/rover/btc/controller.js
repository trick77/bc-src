...
const BTC_SYNCHRONIZATION_STOP = exports.BTC_SYNCHRONIZATION_STOP = '000000000000000000014ac8a1f5e6704f5b14502bbbd2b84a3516cd7402735e'; // 646678
...
class Controller {
    ...
    this._initialSyncHandler = firstRoveredBlock => {
      ...
      if (this.initialSync === INITIAL_RESYNC_STATE.REQUESTED) {
        ...
        if (!isEmpty(this.resyncData.getIntervalsList())) {
          ...
          this._initialSyncPeers = this._sendToRandomPeers(initialSyncBlocks, 16);
      ...
      switch (message.getType()) {// Also could be message.getPayloadCase()
        ...
        case RoverMessageType.ROVER_BLOCK_RANGE:
          ...
          if (this._initialBlocksToFetchCount !== 0) {
            this._logger.warn(`block range request made during active sync...`);
          }
          ...
          try {
            ...
            if (!this._hadQuorumAtLeastOnce) {
              ...
              if (BTC_BOOT_BLOCK) {
                ...
                this._sendToRandomPeers(getLatestBlock, 16);
              }
            }
          } catch (err) {
  ...
  _sendToRandomPeers(message, quorumFraction = 16) {
