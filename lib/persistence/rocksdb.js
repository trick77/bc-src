...
class PersistenceRocksDb {
  ...
  async getTxFromInput(txInput) {
    ...
    //exception
    if (txInput.getHash() === '4f296ca2410f5676aeae3fad19270bc69661f461a55f4e1ea94a64cb1c756f81') {
  ...
  async getTxData(tx, utxos, stxos, blockHash) {
    ...
    if (tx) {
      ...
      if (blockHash === '88fbc8627a70f0767a997047f8c70a0859d826334d82b3507066875b244b9fc7') {
        arr = arr.filter(a => {
          return a.tx2 !== '4f296ca2410f5676aeae3fad19270bc69661f461a55f4e1ea94a64cb1c756f81';
        });
      }
