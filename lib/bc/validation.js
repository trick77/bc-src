...
const BC_MAX_NEW_BLOCKS = 100000;
...
const validRoverChain = exports.validRoverChain = async (rovers, persistence) => {
  ...
  logger.info(`assembled multiverse from ${newBlockHeadersKeys.length} rovers with ${totalNewBlocks.length} connected chain blocks`);
