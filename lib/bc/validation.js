...
const isCoinbaseValid = exports.isCoinbaseValid = async (block, persistence, txHandler) => {
  if (block.getHeight() !== 1) {
    ...
    if (!validTxs && blockHeight < 3219628 || !validTxs && blockHeight > 3220963) {
      // LDL
    ...
    // 3220463
    if (!coinbaseTxValue.eq(grant) && blockHeight < 3219628 || !coinbaseTxValue.eq(grant) && blockHeight > 3220963) {
