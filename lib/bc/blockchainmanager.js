...
class BlockchainManager {
  ...
  constructor(colliderChain = 'bc', emblemChain = 'eth', chainState, opts = {}) {
     ...
     * @class BlockchainManager
     * !!! IMPORTANT !!!
     * The class is READ ONLYnever writes to ChainState, disk, nor access persistence.
   ...
   */
  _defaultBlockExtendsChain(block) {
    ...
    if (!latestBlockHeight || !latestBlockHash) {
      // DEBUG
      this._logger.info(`blockchain ${blockchain} latest block height not available for review`);
      return true;
    }
