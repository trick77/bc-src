          ...
          if (new BN(unmount).gt(new BN(checkCoinbaseBlock.getHeight()))) {
            ...
            if (unmountRaw) {
              ...
              if (!block) {
                ...
                this._engine._emitter.emit('requestBlockRange', [uheight + BC_MAX_DATA_RANGE, uheight - 4], 3);
                return;
              }
    ...
    if (type === MESSAGES.BLOCK) {
      ...
      if (iph === 'running' && ipd === 'pending') {
        ...
        if (latestBlock) {
          ...
          if (latestBlockChildSum - 10 > newBlockChildSum && synced === 'complete' || latestBlock.getHeight() - 30 > block.getHeight() && synced === 'complete') {
        ...
        if (synced === 'complete' && highestKnownHeight && parseInt(highestKnownHeight, 10) - 30 > parseInt(block.getHeight(), 10)) {
