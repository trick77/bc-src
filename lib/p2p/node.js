...
const BC_QUARANTINE_FORGIVENESS = BC_BLOODLINE ? 35000 : getRandomWithinRange(20166, 24900);
      ...
      if (remount) {
        ...
        if (unmount) {
          ...
          if (new BN(unmount).gt(new BN(checkCoinbaseBlock.getHeight()))) {
            ...
            this._engine._emitter.emit('requestBlockRange', [unmount + BC_MAX_DATA_RANGE, unmount - 8], 1);
            return;
          }
        } else {
          forceBreak = true;
