          ...
          if (opts.innerCall) {
            ...
            if (blockQueue.length === 0) {
              ...
              if (missingBlockHeight) {
                ...
                this._logger.warn(`unconfirmed at ${missingBlockHeight} for ref block ${newBlock.getHeight()} : ${newBlock.getHash().slice(0, 21)}, prev: ${newBlock.getPreviousHash().slice(0, 21)} `);
              }
            } else {
              // new candidate found
