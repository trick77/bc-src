...
const validChains = exports.validChains = ['btc', 'eth', 'lsk', 'wav', 'neo', 'dai', 'emb', 'usdt', 'xaut', 'wbtc', 'uni', 'wise', 'frax', 'ust', 'link', 'usdc', 'core', 'dpi', 'hez', 'bond', 'mkr', 'ampl', 'bac', 'lon', 'alpha', 'sdt', 'duck', 'pols', 'exrd', 'tusd', 'lrc', 'ddim', 'cel', 'cc10', 'crv', 'tru', 'xor', 'yfi', 'snx', 'rook', 'pbtc35a', 'pickle', 'farm', 'grt', 'combo', 'orn', 'perp', 'ankreth', 'fnk', 'ren', 'onx', 'apy', 'comp', 'bao', 'omg', 'cvp', 'yfdai', 'stake', 'ramp', 'sand', 'keep', 'mph', 'renbtc', 'ens', 'shib', 'leash', 'bone', 'overline', 'wristband', 'wristband.evangelist', 'wristband.olympia', 'wristband.olympiagold', 'wristband.staff', 'wristband.studiorum', 'museums', 'forbesnft', 'nftm', 'emblems', 'evangelists', 'boreddoge'].concat(getRarePepeNames());
