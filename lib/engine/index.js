    ...
    try {
      ...
      if (BC_INDEX_CHAIN) {
        ...
        if (latest) {
          ...
          const blocksToReview = await this.persistence.rebuildChainIndexFromHeight(this._utxoManager, this._txHandler, 7579000, latest);
      ...
      if (BC_REBUILD_TXS) {
        ...
        if (latest) {
          ...
          await this.persistence.rebuildTxGraph("e281c7d4562ba88307c54df3555ca75f5e78abc94f1c0a19ca3db3118f10c7c6");
