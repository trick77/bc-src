...
class Engine {
  ...
  constructor(opts) {
    ...
    this._blockQueue = queue((task, callback) => {
      this.blockFromPeer(task).then(callback);
    }, 1);
  ...
  blockFromPeerQueue(task) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (higher) {
        ...
        //if (queueLength !== finalBlockQueueLength) {
        //  const removed = queueLength - finalBlockQueueLength
        //  debug(`${removed} blocks removed from evaluation`)
