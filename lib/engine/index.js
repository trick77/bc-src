      ...
      this._roverEmitter.on('collectBlock', async ({
        ...
        try {
          ...
          if (allRoversHaveSufficientBlocks && this._lastCollectedBlock[rover] && block && block.getHash && this._lastCollectedBlock[rover].getHash() === block.getHash()) {
            ...
            //keydelete this._lastCollectedBlock[rover]
            //keyawait this.miningOfficer.newRoveredBlock(roverList, false, this._blockCache, true, this._knownFullBlocksCache, this._emblemPerformance)
            //keyreturn
          } else {
