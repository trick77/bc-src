...
class Engine {
  ...
  constructor(opts) {
    ...
    this._txPendingPool = new TxPendingPool(this._persistence, this._relayMode);
  ...
  async processTx(newTx, conn) {
    ...
    try {
      ...
      if (latestTimeDiff > 1000 * 60 * 10) {
        ...
        const validTx = this._relayMode ? true : await this._txHandler.isValidTx(newTx, { block, latestBlockHeight: block.getHeight() });
        if (validTx) {
