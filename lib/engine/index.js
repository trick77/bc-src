...
class Engine {
  ...
  constructor(opts) {
    ...
    this._miningEmitter = this._emitter;
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        if (rangeRequest && rangeRequest.highestHeight && needsResync) {
          this._logger.warn(`mined block ${newBlock.getHeight()} did not extend multiverse requesting range...`);
          this._emitter.emit('requestBlockRange', [rangeRequest.highestHeight - 5, rangeRequest.lowestHeight - 10], 4);
