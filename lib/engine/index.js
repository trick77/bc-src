    ...
    setInterval(async () => {
      if (!this._disableEmblemCheck) {
        ...
        if (lb.getHash) {
          ...
          const remainingSeconds = max(0, Math.round(remaining / 6.6));
          ...
          console.log(`   Emblem GPU Performance: ${this._emblemPerformance}%`);
          console.log(`   Activation Height: ${threshold}`);
          console.log(`   Blocks Remaining: ${remaining}`);
          console.log(`   Est Days: ${remainingDays}`);
          console.log(`   Est Hours: ${remainingHours}`);
          console.log(`   Est Seconds: ${remainingSeconds}`);
