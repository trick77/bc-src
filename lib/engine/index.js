  ...
  async _processMinedBlock(newBlock, solution, innerCalls = 0) {
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const { valid, stored, needsResync, rangeRequest, schedules, assertSyncComplete, blockSendingAlternative } = await this.multiverse.extendMultiverse(newBlock, 'local', true);
