...
const main = exports.main = async (args = process.argv) => {
  ...
  const errorHandlers = {
    ...
    handle: (type, err) => {
      logger.log('error', 'type = %s, err = %s', type, err.stack);
    }
  };
