...
const { signData, pubKeyRecover, pubKeyToAddrHuman } = require('../core/txUtils');
...
const pubKey = pubKeyRecover(testData, signature);
...
console.log(`Address ${pubKeyToAddrHuman(pubKey)}`); // eslint-disable-line no-console