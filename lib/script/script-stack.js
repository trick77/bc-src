...
class ScriptStack {
  ...
  OP_MAKERCOLL() {
    ...
    receivesUnit = new _decimal.Decimal(receivesUnit).mul(this.env.RATIO).div(new _decimal.Decimal(this.env.BASE)).toString();
    sendsUnit = new _decimal.Decimal(sendsUnit).mul(this.env.RATIO).div(new _decimal.Decimal(this.env.BASE)).toString();
