...
class ScriptStack {
  ...
  OP_MAKERCOLL() {
    ...
    receivesUnit = new _decimal.Decimal(receivesUnit).div(this.env.RATIO).div(new _decimal.Decimal(this.env.BASE)).toNumber();
    sendsUnit = new _decimal.Decimal(sendsUnit).div(this.env.RATIO).div(new _decimal.Decimal(this.env.BASE)).toNumber();
